...
["", "app.dart", , S, {
main: function() {
  var game, conn, t1, t2, t3;
  F.drawLogo();
  game = F.Game$();
  conn = new F.Connection(null, C.JSString_methods.$add("ws://", J.get$host$x(C.Window_methods.get$location(window))) + "/ws", game);
  conn._init$0();
  t1 = $.get$loginBtn();
  t1.toString;
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.main_closure(game, conn)), t1._useCapture);
  ...
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new S.main_closure0(game, conn)), t2._useCapture);
...
main_closure: {"": "Closure;game_0,conn_1",
  call$1: function(e) {
    var t1;
    if (J.get$value$x($.get$inputNickname()) !== "") {
      t1 = this.game_0;
      t1.me.nickname = J.get$value$x($.get$inputNickname());
      t1 = H.fillLiteralMap(["cmd", "getNumber", "arg", t1.me.nickname], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      this.conn_1.ws.send(C.C_JsonCodec.encode$1(t1));
    }
  },
  $is_args1: true
},
...
main_closure0: {"": "Closure;game_2,conn_3",
  call$1: function(e) {
    ...
    if (typeof t1 !== "number")
      throw t1.$tdiv();
    t1 = C.JSNumber_methods.$tdiv(t1, 200);
    if (typeof t2 !== "number")
      throw t2.$tdiv();
    cell = t1 * 3 + C.JSNumber_methods.$tdiv(t2, 200);
    t1 = this.game_2;
    if (t1.me.myTurn === true) {
      ...
      t2 = false;
    if (t2) {
      t1 = H.fillLiteralMap(["cmd", "move", "arg", H.fillLiteralMap(["player", t1.me.number, "cell", cell], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      this.conn_3.ws.send(C.C_JsonCodec.encode$1(t1));
    }
  },
  $is_args1: true
}},
1],
["client_library", "package:dart_OXO_client/client_library.dart", , F, {
drawGrid: function() {
...
drawCell: function(context, cell, number) {
  ...
  if (typeof cell !== "number")
    throw cell.$mod();
  x = C.JSNumber_methods.$mod(cell, 3) * 200;
  y = C.JSNumber_methods.$tdiv(cell, 3) * 200;
  switch (number) {
    case 1:
      F.drawO(context, x, y);
      break;
...
drawX: function(context, x, y) {
  ...
  context.lineTo(t3, t4);
  context.moveTo(t1, t4);
  context.lineTo(t3, t2);
  context.closePath();
  context.stroke();
},

highlightCells: function(triple, number) {
  J.forEach$1$ax(triple, new F.highlightCells_closure(number));
  F.drawGrid();
},

drawLogo: function() {
  F.drawO($.get$contextLogo(), 0, 0);
  F.drawX($.get$contextLogo(), 200, 0);
  F.drawO($.get$contextLogo(), 400, 0);
},

hideLogin: function() {
  J.set$visibility$x($.get$loginPanel().style, "hidden");
  J.set$display$x($.get$loginPanel().style, "none");
  J.set$visibility$x($.get$gamePanel().style, "visible");
  J.set$display$x($.get$gamePanel().style, "block");
},

showLogin: function() {
  J.set$visibility$x($.get$loginPanel().style, "visible");
  J.set$display$x($.get$loginPanel().style, "block");
  J.set$visibility$x($.get$gamePanel().style, "hidden");
  J.set$display$x($.get$gamePanel().style, "none");
},

updateGameStats: function(game) {
  J.set$innerHtml$x($.get$meStats(), F.symbol(game.me) + " " + H.S(game.me.nickname) + ": " + H.S(game.me.points));
  J.set$innerHtml$x($.get$opponentStats(), F.symbol(game.opponent) + " " + H.S(game.opponent.nickname) + ": " + H.S(game.opponent.points));
},

symbol: function(player) {
  if (J.$eq(player.number, 1))
...
accessDenied: function() {
  var error, t1;
  error = document.createElement("p", null);
  t1 = error.style;
  J.getInterceptor$x(t1).set$color(t1, "#a52a2a");
  C.CssStyleDeclaration_methods.set$marginLeft(t1, "auto");
  C.CssStyleDeclaration_methods.set$marginRight(t1, "auto");
  C.CssStyleDeclaration_methods.set$width(t1, "600px");
  C.CssStyleDeclaration_methods.set$backgroundColor(t1, "#FFBABA");
  C.CssStyleDeclaration_methods.set$marginTop(t1, "25px");
  C.CssStyleDeclaration_methods.set$borderRadius(t1, "15px");
  C.CssStyleDeclaration_methods.set$padding(t1, "20px");
  error.textContent = "Oops, there are already two players in, please try again later";
  $.get$loginPanel().appendChild(error);
  P.Timer_Timer(P.Duration$(0, 0, 0, 0, 0, 5), new F.accessDenied_closure(error));
},

Connection: {"": "Object;ws,url,game",
  _init$0: function() {
    var t1, t2;
    this.ws = W.WebSocket_WebSocket(this.url, null);
    t1 = this.ws;
    t1.toString;
    t1 = new W._EventStream(t1, C.EventStreamProvider_open._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Connection__init_closure()), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = this.ws;
    t2.toString;
    t2 = new W._EventStream(t2, C.EventStreamProvider_close._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Connection__init_closure0()), t2._useCapture);
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Connection__init_closure1(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  send$1: function(_, message) {
    this.ws.send(C.C_JsonCodec.encode$1(message));
  }
},
...
Connection__init_closure1: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    dataFromServer = C.C_JsonCodec.decode$1(J.get$data$x(e));
    t1 = J.getInterceptor$asx(dataFromServer);
    switch (t1.$index(dataFromServer, "cmd")) {
      case "start":
        t2 = this.this_0;
        t3 = t2.game;
        t3.me.myTurn = J.$index$asx(C.C_JsonCodec.decode$1(J.$index$asx(t1.$index(dataFromServer, "arg"), J.toString$0(t3.me.number))), "myTurn");
        t3.me.points = J.$index$asx(C.C_JsonCodec.decode$1(J.$index$asx(t1.$index(dataFromServer, "arg"), J.toString$0(t3.me.number))), "points");
        t3.opponent.nickname = J.$index$asx(C.C_JsonCodec.decode$1(J.$index$asx(t1.$index(dataFromServer, "arg"), J.toString$0(t3.opponent.number))), "nickname");
        t3.opponent.points = J.$index$asx(C.C_JsonCodec.decode$1(J.$index$asx(t1.$index(dataFromServer, "arg"), J.toString$0(t3.opponent.number))), "points");
        F.updateGameStats(t3);
        if (t3.me.myTurn === true)
          P.Future_Future$delayed(P.Duration$(0, 0, 0, 50, 0, 0), new F.Connection__init__closure(), null);
        else
          P.Future_Future$delayed(P.Duration$(0, 0, 0, 50, 0, 0), new F.Connection__init__closure0(t2), null);
        t1 = t3.occupiedCells;
        t1.clear$0(t1);
      ...
      case "setNumber":
        t2 = this.this_0.game;
        t2.me.number = t1.$index(dataFromServer, "arg");
        t1 = t2.opponent;
        t3 = t2.me.number;
        if (typeof t3 !== "number")
          throw t3.$mod();
        t1.number = C.JSNumber_methods.$mod(t3, 2) + 1;
        if (J.$eq(t2.me.number, 1))
        ...
        break;
      case "move":
        cell = J.$index$asx(t1.$index(dataFromServer, "arg"), "cell");
        player = J.$index$asx(t1.$index(dataFromServer, "arg"), "player");
        t1 = this.this_0.game;
        t2 = t1.occupiedCells;
        t2.add$1(t2, cell);
        F.drawCell($.get$contextGame(), cell, player);
        t1.me._toggleTurn$0();
        t1.opponent._toggleTurn$0();
        if (t1.me.myTurn === true)
          $.get$status().textContent = "It's your turn";
        else {
          t1 = "It's " + H.S(t1.opponent.nickname) + "'s turn.";
      ...
      case "end":
        t2 = this.this_0.game;
        t2.me.myTurn = false;
        if (!J.$eq(t1.$index(dataFromServer, "arg"), "drawn")) {
          triple = J.$index$asx(t1.$index(dataFromServer, "arg"), "triple");
          number = J.$index$asx(t1.$index(dataFromServer, "arg"), "winner");
          F.highlightCells(triple, number);
          if (J.$eq(t2.me.number, number))
            $.get$status().textContent = "You won!";
          else {
            t1 = H.S(t2.opponent.nickname) + " won.";
            $.get$status().textContent = t1;
          }
        } else
      ...
      case "reset":
        t1 = this.this_0.game;
        F.updateGameStats(t1);
        t1.me._reset$0();
        t1.opponent._reset$0();
        t1 = t1.occupiedCells;
        t1.clear$0(t1);
        F.showLogin();
        break;
...
Connection__init__closure0: {"": "Closure;this_1",
  call$0: function() {
    var t1 = "It's " + H.S(this.this_1.game.opponent.nickname) + "'s turn";
    $.get$status().textContent = t1;
  }
},
...
Game: {"": "Object;me,opponent,occupiedCells",
  Game$0: function() {
    this.me = new F.Player(null, null, null, null);
    this.opponent = new F.Player(null, null, null, null);
    this.occupiedCells = P.LinkedHashSet_LinkedHashSet(null, null, null, J.JSInt);
  },
  static: {
Game$: function() {
  var t1 = new F.Game(null, null, null);
  t1.Game$0();
  return t1;
}}
...
highlightCells_closure: {"": "Closure;number_0",
  call$1: function(cell) {
    ...
    switch (this.number_0) {
      case 1:
        F.drawO($.get$contextGame(), x, y);
        break;
      case 2:
        F.drawX($.get$contextGame(), x, y);
        break;
      default:
    }
  },
...
accessDenied_closure: {"": "Closure;error_0",
  call$0: function() {
    J.remove$0$ax(this.error_0);
  }
},

Player: {"": "Object;nickname,number,myTurn,points",
  _toggleTurn$0: function() {
    if (this.myTurn === true)
      this.myTurn = false;
    else
      this.myTurn = true;
...
AnchorElement: {"": "HtmlElement;host=,hostname=,href},port=,protocol=",
  toString$0: function(receiver) {
...
AreaElement: {"": "HtmlElement;host=,hostname=,href},port=,protocol=", "%": "HTMLAreaElement"},
...
Location: {"": "Interceptor;host=,hostname=,port=,protocol=",
  toString$0: function(receiver) {
    return receiver.toString();
  },
  $isLocation: true,
...
Isolate.$lazy($, "contextLogo", "contextLogo", "get$contextLogo", function() {
  return J.get$context2D$x($.get$canvasLogo());
});
Isolate.$lazy($, "contextGame", "contextGame", "get$contextGame", function() {
  return J.get$context2D$x($.get$canvasGame());
});
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(game_0, conn_1) {
    this.game_0 = game_0;
    this.conn_1 = conn_1;
  }
  ...
  function main_closure0(game_2, conn_3) {
    this.game_2 = game_2;
    this.conn_3 = conn_3;
  }
  ...
  function Connection(ws, url, game) {
    this.ws = ws;
    this.url = url;
    this.game = game;
  }
  ...
  function Connection__init_closure() {
  }
  Connection__init_closure.builtin$cls = "Connection__init_closure";
  if (!"name" in Connection__init_closure)
    Connection__init_closure.name = "Connection__init_closure";
  $desc = $collectedClasses.Connection__init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Connection__init_closure.prototype = $desc;
  function Connection__init_closure0() {
  }
  Connection__init_closure0.builtin$cls = "Connection__init_closure0";
  if (!"name" in Connection__init_closure0)
    Connection__init_closure0.name = "Connection__init_closure0";
  $desc = $collectedClasses.Connection__init_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Connection__init_closure0.prototype = $desc;
  function Connection__init_closure1(this_0) {
    this.this_0 = this_0;
  }
  Connection__init_closure1.builtin$cls = "Connection__init_closure1";
  if (!"name" in Connection__init_closure1)
    Connection__init_closure1.name = "Connection__init_closure1";
  $desc = $collectedClasses.Connection__init_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Connection__init_closure1.prototype = $desc;
  function Connection__init__closure() {
  }
  Connection__init__closure.builtin$cls = "Connection__init__closure";
  if (!"name" in Connection__init__closure)
    Connection__init__closure.name = "Connection__init__closure";
  $desc = $collectedClasses.Connection__init__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Connection__init__closure.prototype = $desc;
  function Connection__init__closure0(this_1) {
    this.this_1 = this_1;
  }
  Connection__init__closure0.builtin$cls = "Connection__init__closure0";
  if (!"name" in Connection__init__closure0)
    Connection__init__closure0.name = "Connection__init__closure0";
  $desc = $collectedClasses.Connection__init__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Connection__init__closure0.prototype = $desc;
  function Game(me, opponent, occupiedCells) {
    this.me = me;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function highlightCells_closure(number_0) {
    this.number_0 = number_0;
  }
  highlightCells_closure.builtin$cls = "highlightCells_closure";
  if (!"name" in highlightCells_closure)
    highlightCells_closure.name = "highlightCells_closure";
  $desc = $collectedClasses.highlightCells_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  highlightCells_closure.prototype = $desc;
  function accessDenied_closure(error_0) {
    this.error_0 = error_0;
  }
  accessDenied_closure.builtin$cls = "accessDenied_closure";
  if (!"name" in accessDenied_closure)
    accessDenied_closure.name = "accessDenied_closure";
  $desc = $collectedClasses.accessDenied_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  accessDenied_closure.prototype = $desc;
  function Player(nickname, number, myTurn, points) {
